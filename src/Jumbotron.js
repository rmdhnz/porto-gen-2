        ...
        <div className="flex justify-center flex-wrap">
          <div className="mt-3 md:w-1/2">
            ...
            <p className="mt-5 font-poppins text-justify dark:text-white">
              ...
              omnis, neque reprehenderit cum eum dolor error provident iure
              quis? Quod repellat laudantium architecto quo minima pariatur
              magni consequuntur, neque ratione?
            </p>
            <button
              className="mt-3 group overflow-hidden text-white font-semibold relative flex items-center py-2 px-8 bg-primary rounded-md"
              type="button"
            >
              <div className="absolute -translate-x-[200%] group-hover:translate-x-0 duration-500">
                Connect Me
              </div>
              <div
